...
public class JanelaBuscarTarifasContas extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JanelaBuscarTarifasContas frame = new JanelaBuscarTarifasContas();
	 ...
	 * Create the frame.
	 */
	public JanelaBuscarTarifasContas() {
		...
		JLabel lbl_titulo = new JLabel("BUSCAR TARIFA CONTA");
		lbl_titulo.setFont(new Font("Tahoma", Font.BOLD, 11));
		lbl_titulo.setBounds(163, 11, 191, 14);
		...
		btn_procurar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (DadosContas.buscar(nroConta) != null) {
					...
					lbl_dadosConta.setText("A tarifa da conta e: " + DadosContas.buscar(nroConta).calculaTarifa());
				}
			}
		});
