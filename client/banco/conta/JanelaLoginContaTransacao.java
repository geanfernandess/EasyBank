...
public class JanelaLoginContaTransacao extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JanelaLoginContaTransacao frame = new JanelaLoginContaTransacao();
	 ...
	 * Create the frame.
	 */
	public JanelaLoginContaTransacao() {
		...
		btn_entrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (DadosContas.buscar(nroConta) != null && DadosContas.buscar(nroConta).getSenha() == senha) {
					JanelaEscolheTransacao.main(null);
				}
			}
		});
