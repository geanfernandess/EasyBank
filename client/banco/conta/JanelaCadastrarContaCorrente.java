...
public class JanelaCadastrarContaCorrente extends JFrame {
	...
	private JTextField c_tipoContaCorrente;
	...
	private JLabel t_tipoContaCorrente;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JanelaCadastrarContaCorrente frame = new JanelaCadastrarContaCorrente();
	 ...
	 * Create the frame.
	 */
	public JanelaCadastrarContaCorrente() {
		...
		JLabel lbl_tituloCadastrarCliente = new JLabel("CADASTRAR CONTA CORRENTE");
		...
		c_tipoContaCorrente = new JTextField();
		c_tipoContaCorrente.setColumns(10);
		c_tipoContaCorrente.setBounds(147, 227, 290, 20);
		contentPane.add(c_tipoContaCorrente);

		c_agenciaCadastro = new JTextField();
		c_agenciaCadastro.setColumns(10);
		c_agenciaCadastro.setBounds(147, 258, 290, 20);
		contentPane.add(c_agenciaCadastro);

		c_cpfCliente = new JTextField();
		c_cpfCliente.setColumns(10);
		c_cpfCliente.setBounds(147, 289, 290, 20);
		...
		t_tipoContaCorrente = new JLabel("Tipo Conta:");
		t_tipoContaCorrente.setFont(new Font("Tahoma", Font.PLAIN, 11));
		t_tipoContaCorrente.setBounds(20, 230, 117, 14);
		contentPane.add(t_tipoContaCorrente);

		t_agenciaCadastro = new JLabel("Agencia Cadastro:");
		t_agenciaCadastro.setFont(new Font("Tahoma", Font.PLAIN, 11));
		t_agenciaCadastro.setBounds(20, 261, 117, 14);
		contentPane.add(t_agenciaCadastro);

		t_cliente = new JLabel("CPF Cliente:");
		t_cliente.setFont(new Font("Tahoma", Font.PLAIN, 11));
		t_cliente.setBounds(20, 292, 117, 14);
		...
		b_CadastrarGerente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int tipoContaCorrente = Integer.parseInt(c_tipoContaCorrente.getText());
				...
				if (DadosAgencias.buscar(agCadastro) != null && DadosClientes.buscar(c_cpfCliente.getText()) != null) {
					DadosContas.cadastrar(new Corrente(codigoConta, c_statusConta.getText().toUpperCase(), senha,
		...
		b_CadastrarGerente.setBounds(170, 378, 117, 23);
		...
		t_statusCadastro.setBounds(20, 336, 106, 14);
		contentPane.add(t_statusCadastro);

		lbl_resultado = new JLabel();
		lbl_resultado.setBounds(147, 336, 290, 14);
		contentPane.add(lbl_resultado);

		JLabel t_statuslLembrete_1 = new JLabel("Digite: 1 para Standard e 2 para Premiun");
		t_statuslLembrete_1.setFont(new Font("Tahoma", Font.PLAIN, 11));
		t_statuslLembrete_1.setBounds(147, 209, 290, 14);
		contentPane.add(t_statuslLembrete_1);
