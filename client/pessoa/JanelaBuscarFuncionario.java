...
import server.pessoa.funcionario.Funcionario;
		...
		btn_procurar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (DadosFuncionarios.buscar(c_cpf.getText()) != null) {
					...
					lbl_dadosFucionarios
							.setText("O nome e: " + DadosFuncionarios.buscar(c_cpf.getText()).getNomeCompleto());
					lbl_dadosFucionarios2
							.setText("O cargo e: " + DadosFuncionarios.buscar(c_cpf.getText()).getCargoEmpresa());
					lbl_dadosFucionarios3.setText(
							"O data de admissao e: " + DadosFuncionarios.buscar(c_cpf.getText()).getDataAdmissao());
					if (DadosFuncionarios.buscar(c_cpf.getText()) instanceof Funcionario) {
						lbl_dadosFucionarios4
								.setText("O salario e: " + DadosFuncionarios.buscar(c_cpf.getText()).calcularSalario());
					}
					if (DadosFuncionarios.buscar(c_cpf.getText()) instanceof Gerente) {
						lbl_dadosFucionarios4.setText("O salario e: "
								+ ((Gerente) DadosFuncionarios.buscar(c_cpf.getText())).calcularSalario());
					}
				}
			}
		});
