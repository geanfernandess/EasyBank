		...
		btn_procurar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (DadosClientes.buscar(c_cpf.getText()) != null) {
					...
					lbl_dadosClientes3.setText("O estado civil e: " + DadosClientes.buscar(c_cpf.getText()).getEstadoCivil() );
					lbl_dadosClientes4.setText("A escolaridade e: " + DadosClientes.buscar(c_cpf.getText()).getEscolaridade() );
				}
