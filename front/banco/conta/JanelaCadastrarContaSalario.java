...
public class JanelaCadastrarContaSalario extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JanelaCadastrarContaSalario frame = new JanelaCadastrarContaSalario();
	 ...
	 * Create the frame.
	 */
	public JanelaCadastrarContaSalario() {
		...
		JLabel lbl_tituloCadastrarCliente = new JLabel("CADASTRAR CONTA SALARIO");
		...
		b_CadastrarGerente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (DadosAgencias.buscar(agCadastro) != null && DadosClientes.buscar(c_cpfCliente.getText()) != null ) {
					DadosContas.cadastrar(new Salario(codigoConta, c_statusConta.getText().toUpperCase(), senha, nrConta, saldoAtual, hoje.getTime(), 
