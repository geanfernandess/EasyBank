...
public class Salario extends Conta {
	...
	public Salario (Integer codigo, String flagueAtiva, Integer senha, Integer numeroConta, double saldoAtual, Date dataAbertura, Agencia agencia, Cliente cliente) {
