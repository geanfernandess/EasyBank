...
public class Transacao  {
	...
	public void efetivaTransacao() {
		// Saque
		if ( this.getTipoTransacao() == 1 && refConta.getSaldoAtual() > 0 && refConta.getSaldoAtual() > this.getValorTransacao()) {
			double novoSaldo = 0;
		...
		// Transferencia
		if ( this.getTipoTransacao() == 2 && refConta.getSaldoAtual() > 0 && refConta.getSaldoAtual() > this.getValorTransacao() ) {
			double novoSaldo = 0;
			novoSaldo = refConta.getSaldoAtual() - this.getValorTransacao();
			refConta.setSaldoAtual(novoSaldo);
